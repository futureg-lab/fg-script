...
namespace fg_script_test
{
    ...
    public class LexerTest
    {
        ...
        {
            string source = "xor   repr_of num  bool  tup   if else elif for   true  false    and or is fn" +
            ...
            {
                TokenType.XOR, TokenType.REPR_OF, TokenType.TYPE, TokenType.TYPE, TokenType.TYPE,
